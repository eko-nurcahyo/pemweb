@php
    ...
    $title = PageConfig::first();
    $detail = PageConfig::first();
    $image = PageConfig::first();
@endphp
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <div class="block text-center text-lg-start pe-0 pe-xl-5">
              <h1 class="text-capitalize mb-4">{{$title->title}}</h1>
              <p class="mb-4">{{$detail->detail}}</p> <a type="button"
